...
<html lang="pl">
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="wyp.php" class="glyphicon glyphicon-tag"> Wypożyczenia</a></li>
  ...
  <div class="container panel panel-default">
    ...
    <?php
      ...
      $sql = "SELECT wypID 'Lp.', concat(klImie, ' ', klNazwisko) 'Imie i nazwisko', filTytul 'Tytuł filmu', wypDataWyp 'Data wyporzyczenia', wypDataOddania 'Data zwrotu' FROM filWypozyczenia NATURAL JOIN filFilmy NATURAL JOIN filKlient;";
      $tab = sql2array($sql);
